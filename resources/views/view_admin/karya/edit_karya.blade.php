...
<div class="card mt-3 border shadow">
    ...
    <form class="form-horizontal" action="/updateKarya/{{ $karya->slug }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Kegiatan/kursus/karya yang pernah diikuti." autofocus type="text"
                            name="karya" value="{{ old('karya',$karya->karya) }}"
                        ...
                        <input required type="hidden" readonly
                            ...
                            value="{{ old('slug',$karya->slug) }}" required>
