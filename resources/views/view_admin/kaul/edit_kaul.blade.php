...
<div class="card mt-3 border shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Edit Data Kaul</h6>
    </div>

    <form class="form-horizontal" action="/updateKaul/{{ $kaul->slug }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            ...
            <div class="row mt-2">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Judul" autofocus type="text" name="nama"
                            value="{{ old('nama',$kaul->nama) }}"
                        ...
                        <input type="hidden" readonly class="form-control shadow @error('slug') is-invalid @enderror"
                            id="slug" name="slug" value="{{ old('slug',$kaul->slug) }}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Tanggal" type="text" name="tgl_kaul"
                            value="{{ old('tgl_kaul',$kaul->tgl_kaul) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Tempat" type="text" name="tpt_kaul"
                            value="{{ old('tpt_kaul',$kaul->tpt_kaul) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input placeholder="Moto" type="text" name="moto" value="{{ old('moto',$kaul->moto) }}"
