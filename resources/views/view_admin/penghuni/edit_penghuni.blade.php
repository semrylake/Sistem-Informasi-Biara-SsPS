...
<div class="card mt-3 border shadow">
    ...
    <form class="form-horizontal" action="/editPenghuni/{{ $slug }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="form-group">
                ...
                <input autofocus placeholder="Nama biara, baptis dan nama keluarga" type="text" name="nama"
                    value="{{ old('nama', $penghuni->nama) }}" class="form-control @error('nama') is-invalid @enderror"
                    id="nama" autocomplete="off" required>
                <input type="hidden" readonly class="form-control shadow @error('slug') is-invalid @enderror" id="slug"
                    name="slug" value="{{ old('slug', $penghuni->slug) }}" required>
            ...
            <div class="form-group">
                ...
                <input autofocus type="text" name="paroki" value="{{ old('paroki',$penghuni->paroki) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input placeholder="Contoh: Kupang" type="text" name="tpt_lahir"
                            value="{{ old('tpt_lahir',$penghuni->tpt_lahir) }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="tgl_lahir" value="{{ old('tgl_lahir',$penghuni->tgl_lahir) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="tgl_baptis" value="{{ old('tgl_baptis',$penghuni->tgl_baptis) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Contoh: Kupang" type="text" name="tpt_baptis"
                            value="{{ old('tpt_baptis',$penghuni->tpt_baptis) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="pembaptis" value="{{ old('pembaptis',$penghuni->pembaptis) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="tgl_msk_biara"
                            value="{{ old('tgl_msk_biara',$penghuni->tgl_msk_biara) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Contoh: Kupang" name="biara_masuk_pertama"
                            value="{{ old('biara_masuk_pertama',$penghuni->biara_masuk_pertama) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input min="1" type="number" name="no_pakaian"
                            value="{{ old('no_pakaian',$penghuni->no_pakaian) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="tgl_masuk_novisiat" class="control-label col-form-label">Tanggal Masuk
                            Novisiat</label>
                        <input type="text" name="tgl_masuk_novisiat"
                            value="{{ old('tgl_masuk_novisiat',$penghuni->tgl_masuk_novisiat) }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="masuki_novisiat_di"
                            value="{{ old('masuki_novisiat_di',$penghuni->masuki_novisiat_di) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Contoh: 2021" name="tgl_filial"
                            value="{{ old('tgl_filial',$penghuni->tgl_filial) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="komunitas_filial"
                            value="{{ old('komunitas_filial',$penghuni->komunitas_filial) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="pekerjaan" class="control-label col-form-label">Menangani Pekerjaan
                            Di</label>
                        <input type="text" name="pekerjaan" value="{{ old('pekerjaan',$penghuni->pekerjaan) }}"
            ...
            <div class="form-group">
                ...
                <img class="img-preview mb-2 img-fluid col-sm-2" style="display: block; height: 100px;"
                    src="{{ asset('storage/'.$penghuni->foto) }}">
                @endif
                ...
                <input type="file" class=" form-control form-control-sm @error('foto') is-invalid @enderror" id="foto"
                    name="foto" value="{{ old('foto',$penghuni->foto) }}" onchange="previewImage()">
                <div class="invalid-feedback text-danger">
                    <div class="invalid-feedback text-danger">
                        @error('foto')
                        {{ $message }}
