...
<div class="card mt-3 border shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Tambah Data Pendidikan Terakhir</h6>
    </div>

    <form class="form-horizontal" action="/addPendidikan" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Tingkat / Jenis Pendidikan" autofocus type="text" name="tingkat"
                            value="{{ old('tingkat') }}" class="form-control @error('tingkat') is-invalid @enderror"
                            id="tingkat" autocomplete="off" required>
