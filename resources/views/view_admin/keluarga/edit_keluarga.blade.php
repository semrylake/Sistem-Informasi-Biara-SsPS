...
<div class="card mt-3 border shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Edit Anggota Keluarga</h6>
    </div>

    <form class="form-horizontal" action="/updateKeluarga/{{ $keluarga->slug }}" method="post"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input autofocus type="text" name="nama" value="{{ old('nama', $keluarga->nama) }}"
                        ...
                        <input required type="hidden" readonly
                            ...
                            value="{{ old('slug', $keluarga->slug) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-label-group">
                            <select class=" form-control @error('jk') is-invalid @enderror" name="jk" id="jk">
                                <option></option>
                                <option id="jk" value="Laki-laki" {{ old('jk', $keluarga->jk)=="Laki-laki" ?
                                    'selected' : null}}
                                    class="form-control">Laki-laki</option>
                                <option id="jk" value="Perempuan" {{ old('jk', $keluarga->jk)=="Perempuan" ? 'selected'
                                    : null}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-label-group">
                            <select class=" form-control @error('status') is-invalid @enderror" name="status"
                                id="status">
                                <option></option>
                                <option id="status" value="Orang Tua - Ayah" {{ old('status', $keluarga->status)=="Orang
                                    Tua - Ayah"
                                    ? 'selected' : null}} class="form-control">Orang Tua - Ayah</option>
                                <option id="status" value="Orang Tua - Ibu" {{ old('status', $keluarga->status)=="Orang
                                    Tua - Ibu"
                                    ? 'selected' : null}} class="form-control">Orang Tua - Ibu</option>
                                <option id="status" value="Saudara" {{ old('status', $keluarga->status)=="Saudara" ?
                                    'selected' : null}}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Tempat Lahir" autofocus type="text" name="tpt_lahir"
                            value="{{ old('tpt_lahir', $keluarga->tpt_lahir) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Tanggal Lahir" autofocus type="text" name="tgl_lahir"
                            value="{{ old('tgl_lahir', $keluarga->tgl_lahir) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input placeholder="Tanggal Kematian (Kosongkan jika tidak ada)" autofocus type="text"
                            name="tgl_meninggal" value="{{ old('tgl_meninggal', $keluarga->tgl_meninggal) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input autofocus type="text" name="tlpn" value="{{ old('tlpn', $keluarga->tlpn) }}"
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input autofocus type="text" name="alamat" value="{{ old('alamat', $keluarga->alamat) }}"
