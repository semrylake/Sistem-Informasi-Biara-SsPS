    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <h3 class="text-white text-center">{{ $today }}</h3>
                    <div class="text-center p-t-20 p-b-20">
                        <h5 class="text-white">Silahkan Login</h5>
                    </div>
                    <!-- Form -->
                    @if (session('pesan'))
                    <h5 class="text-danger text-center">{{ session('pesan') }}</h5>
                    @endif
                    @if (session('updpass'))
                    ...
                    <form method="post" action="/loginprocess">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success text-white"
                                            value="{{ old('username') }}"><i class="ti-user"></i></span>
                                    </div>
                        ...
                        <div class="border-top border-secondary">
                            <div class="p-t-20">
                                <button type="submit" class="btn btn-success" name="masuk"
